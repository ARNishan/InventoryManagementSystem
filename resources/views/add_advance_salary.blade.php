        ...
        <div class="col-md-2"></div>
         ...
         <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading"><h3 class="panel-title">Advance Salary Provide
                <a href="{{ route('all.advance.salary') }}" class="pull-right btn btn-purple waves-effect waves-light">All Advance Salary</a>
                </h3></div>
                    @if ($errors->any())
