            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="md md-terrain"></i> <span>ABC Comphany </span></a>
                    </div>
                </div>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                ...
                                <a href="{{ route('pos') }}" class="waves-effect"><i class="md md-home"></i><span><b> POS </b></span></a>
                            </li>
                           ...
                           <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.supplier') }}">Add Suplier</a></li>
                                    <li><a href="{{ route('all.supplier') }}">All Suplier</a></li>
                                    
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-palette"></i> <span>Salary</span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.advance.salary') }}">Add Advace Salary</a></li>
                                    <li><a href="{{ route('all.advance.salary') }}">All Advaced Salary</a></li>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-palette"></i> <span> Catagories </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.catagory') }}">Add Catagories</a></li>
                                    <li><a href="{{ route('all.catagory') }}">All Catagories</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="{{ route('success.orders') }}">Success Order</a></li>
